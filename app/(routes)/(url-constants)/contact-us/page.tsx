...
import { Facebook, Instagram, MessageCircle, InstagramIcon as TiktokIcon } from 'lucide-react'

export default function ContactPage() {
  return (
    <Card className="w-full max-w-md mx-auto bg-[#f8f8f8] mt-6">
      <CardHeader className="text-center">
        <CardTitle className="text-2xl font-light tracking-wider">streethues.</CardTitle>
      ...
      <CardContent className="grid gap-4">
        <Button 
          ...
          onClick={() => window.open('https://www.tiktok.com/@streethues', '_blank')}
        >
        ...
        <Button 
          variant="outline" 
          className="w-full flex justify-start gap-2 h-12"
          onClick={() => window.open('https://www.facebook.com/streethuesclthg', '_blank')}
        >
        ...
        <Button 
          variant="outline" 
          className="w-full flex justify-start gap-2 h-12"
          onClick={() => window.open('https://www.instagram.com/streethuesclthg', '_blank')}
        >
